...
class PlatformChannelProvider {
  ...
  void setup() {
    GetIt.instance.registerSingleton<PlatformChannelDownloaderService>(PlatformChannelDownloaderService());
  }

  PlatformChannelDownloaderService get platformChannelDownloaderService => GetIt.instance<PlatformChannelDownloaderService>();
}
// class PlatformChannelProvider {
